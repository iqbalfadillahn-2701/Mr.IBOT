...
/////////////////
const BotName = '™MR•I`{2701}°√'; 
const instagram = 'https://instagram.com/iqbal_fn2701'; 
const telegram = 'https://t.me/MrI2701'; 
const kapanbotaktif = 'KETIKA BOT DIAKTIFKAN'; 
const youtube = 'https://youtube.com/c/CYBER BLACK HAT';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@iqbal_fn2701')
